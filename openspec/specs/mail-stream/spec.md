# mail-stream Specification

## Purpose
Mail is stream #1: Gmail/Yandex copy, unified folders, identifier-only threads, inbox important/unimportant, tile menu and Shift range, attachment gallery, HTML iframe.
