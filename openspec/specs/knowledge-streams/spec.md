# knowledge-streams Specification

## Purpose
Common `knowledge_items` envelope plus per-kind tables. v1 writes only `stream_kind=mail`. Topics and distribution routes exist in schema without UI or a dispatcher.
